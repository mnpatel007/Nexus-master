...
import sys
import urllib.parse
from Nexus.features import date_time
from Nexus.features import launch_app
from Nexus.features import website_open
from Nexus.features import weather
from Nexus.features import wikipedia
from Nexus.features import news
from Nexus.features import send_email
from Nexus.features import note
from Nexus.features import system_stats
from Nexus.features import loc
...
class NexusAssistant:
    ...
    def send_mail(self, receiver_email, msg):

        return send_email.mail(receiver_email, msg)
